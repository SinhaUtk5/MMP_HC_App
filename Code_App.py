...
st.markdown('<style>h2{color: red;}</style>', unsafe_allow_html=True)
st.markdown("[Download Input Template From This Link.](https://drive.google.com/file/d/1HNyZjobmTEBcWfk0C2cmClQfahTONrX1/view?usp=sharing)",unsafe_allow_html=True)
