...
st.markdown('<style>h2{color: red;}</style>', unsafe_allow_html=True)
st.markdown("[Download Input Template](https://drive.google.com/file/d/1HNyZjobmTEBcWfk0C2cmClQfahTONrX1/view?usp=sharing)<style>h2{color: red;}</style>",unsafe_allow_html=True)
