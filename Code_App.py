...
st.write('<p style="font-size:26px; color:red;">Input Template Download </p> [Link](https://drive.google.com/file/d/1HNyZjobmTEBcWfk0C2cmClQfahTONrX1/view?usp=sharing))
#st.write(df)
